  ...
  <div class="my-container">
    ...
    <div v-else class="not-login">
      <div @click="$router.push('/login')">
        <img class="mobile" src="https://github.com/lipengzhou/toutiao-mobile/blob/master/src/views/my/%E6%89%8B%E6%9C%BA.png">
      </div>
  ...
  methods: {
    onLogout () {
      this.$dialog.confirm({
        title: '退出提示',
        message: '确认退出吗？'
      }).then(() => { this.$store.commit('setUser', null) }).catch(() => { })
    },
